...
colorjack.keyboard.Keyboard = function() {
	...
	var keys = {
		...
		'36': function(k) { // home key
			navig.home(k);
		},
		'35': function(k) { // end key
			navig.end(k);
		},
		'33': function(k) { // page up
			navig.pageUp(k);
		},
		'34': function(k) { // page down
			navig.pageDown(k);
		},
		'37': function(k) { // arrow left
			navig.arrowLeft(k);
			return false;
		},
		'38': function(k) { // arrow up
			navig.arrowUp(k);
			return false;
		},
		'39': function(k) { // arrow right
			navig.arrowRight(k);
			return false;
		},
		'40': function(k) { // arrow down
			navig.arrowDown(k);
			return false;
		},
		'46': function(k) { // delete key
			keyEditor.deleteKey(k);
			return false;
		},
		'45': function(k) { // insert key
