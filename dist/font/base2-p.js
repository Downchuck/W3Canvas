...
new function (_) { var _0 = "function base(o,a){return o.base.apply(o,a)};"; eval(_0); var detect = base2.detect; var Undefined = K(), Null = K(null), True = K(true), False = K(false); var _1 = /%([1-9])/g; var _2 = /^\s\s*/; var _3 = /\s\s*$/; var _4 = /([\/()[\]{}|*+-.,^$?\\])/g; var _5 = /eval/.test(detect) ? /\bbase\s*\(/ : /.*/; var _6 = ["constructor", "toString", "valueOf"]; var _7 = detect("(jscript)") ? new RegExp("^" + rescape(isNaN).replace(/isNaN/, "\\w+") + "$") : { test: False }; var _8 = 1; var _9 = Array.prototype.slice; var slice = Array.slice || function (a) { return _9.apply(a, _9.call(arguments, 1)); }; _10(); var _11 = function (a, b) { base2.__prototyping = this.prototype; var c = new this; extend(c, a); delete base2.__prototyping; var d = c.constructor; function e() { if (!base2.__prototyping) {
    ...
    e[i] = this[i]; e.ancestor = this; e.base = Undefined; e.init = Undefined; extend(e, b); e.prototype = c; e.init(); return e; }; var Base = _11.call(Object, { constructor: function () { if (arguments.length > 0) {
    ...
    } return this; } }); var Package = Base.extend({ constructor: function (d, e) { this.extend(e); if (this.init)
        this.init(); if (this.name != "base2") {
        if (!this.parent)
            this.parent = base2;
    ...
    } }, addPackage: function (a) { this.addName(a, new Package(null, { name: a, parent: this })); }, toString: function () { return format("[%1]", this.parent ? String(this.parent).slice(1, -1) + "." + this.name : this.name); } }); var Abstract = Base.extend({ constructor: function () { throw new TypeError("Class cannot be instantiated."); } }); var Module = Abstract.extend(null, { extend: function (a, b) { var c = this.base(); c.implement(this); c.implement(a); extend(c, b); c.init(); return c; }, implement: function (d) { var e = this; if (typeof d == "function") {
        if (!_12(d, e)) {
            this.base(d);
        }
        if (_12(Module, d)) {
        ...
        else if (typeof b == "function" && b.call) {
            e.prototype[c] = function () { var a = _9.call(arguments); a.unshift(this); return e[c].apply(e, a); };
        } });
    } return e; } }); var Enumerable = Module.extend({ every: function (c, d, e) { var f = true; try {
        ...
        this[_15].sort(); return this; }, toString: function () { return String(this[_15]); } }, { Item: null, create: function (a, b) { return this.Item ? new this.Item(a, b) : b; }, extend: function (a, b) { var c = this.base(a); c.create = this.create; extend(c, b); if (!c.Item) {
        c.Item = this.Item;
    }
    else if (typeof c.Item != "function") {
        c.Item = (this.Item || Base).extend(c.Item);
    } c.init(); return c; } }); var _16 = /\\(\d+)/g, _17 = /\\./g, _18 = /\(\?[:=!]|\[[^\]]+\]/g, _19 = /\(/g, _20 = /\$(\d+)/, _21 = /^\$\d+$/; var RegGrp = Collection.extend({ constructor: function (a, b) { this.base(a); if (typeof b == "string") {
        ...
        arguments[0] = a.source;
            ...
            b = ""; if (typeof b == "string" && _20.test(b)) {
            if (_21.test(b)) {
...
} Function.prototype.prototype = {}; if ("".replace(/^/, K("$$")) == "$") {
    extend(String.prototype, "replace", function (a, b) { if (typeof b == "function") {
        ...
        b = function () { return String(c.apply(null, arguments)).split("$").join("$$"); };
            ...
            e = d; return this.reduce(d, function (a, b, c) { a[b] = e[c]; return a; }, {}); }, contains: function (a, b) { return this.indexOf(a, b) != -1; }, copy: function (a) { var b = _9.call(a); if (!b.swap)
            this(b); return b; }, flatten: function (c) { var d = 0; return this.reduce(c, function (a, b) { if (this.like(b)) {
            ...
            b += a.length; return a[b]; }, lastIndexOf: function (a, b, c) { var d = a.length; if (c == null) {
            c = d - 1;
        }
        else if (c < 0) {
            c = Math.max(0, d + c);
    ...
    default: return new Date(a, b, arguments.length == 2 ? 1 : c, h || 0, m || 0, s || 0, d || 0);
            ...
            d = d.replace(/#+/, function (a) { var b = c["getUTC" + e](); if (e == "Month")
                b++; return ("000" + b).slice(-a.length); });
        } return d.replace(_28, "").replace(_29, "$1Z"); } }]); Date2.now = function () { return (new Date).valueOf(); }; Date2.parse = function (a, b) { if (arguments.length > 1) {
...
} return a; } ; function _12(a, b) { while (b) {
    if (!b.ancestor)
        return false;
    b = b.ancestor;
    if (b == a)
        return true;
} return false; } ; function _22(c, d, e) { var f = c[d]; var g = base2.__prototyping; if (g && f != g[d])
    g = null; function h() { var a = this.base; this.base = g ? g[d] : f; var b = e.apply(this, arguments); this.base = a; return b; } ; h.ancestor = f; c[d] = h; } ; if (typeof StopIteration == "undefined") {
...
} _10(d || Object, a, b, c); } ; function _24(a, b, c) { if (a == null)
    return; var d = a.length, i; if (typeof a == "string") {
    for (i = 0; i < d; i++) {
        b.call(c, a.charAt(i), i, a);
    }
}
else {
    for (i = 0; i < d; i++) { /*@cc_on@*/ /*@if(@_14<5.2)if($Legacy.has(a,i))@else@*/
        if (i in a) /*@end@*/
            b.call(c, a[i], i, a);
    }
} } ; function _10(g, h, j, k) { var l = function () { this.i = 1; }; l.prototype = { i: 1 }; var m = 0; for (var i in new l)
    m++; _10 = (m > 1) ? function (a, b, c, d) { var e = {}; for (var f in b) {
...
} }; _10(g, h, j, k); } ; function typeOf(a) { var b = typeof a; switch (b) {
    ...
    default: return b;
} } ; function instanceOf(a, b) { if (typeof b != "function") {
    throw new TypeError("Invalid 'instanceOf' operand.");
} if (a == null)
    return false; /*@cc_on if(typeof a.constructor!="function"){return typeOf(a)==typeof b.prototype.valueOf()}@*/ /*@if(@_14<5.1)if($Legacy.instanceOf(a,b))return true;@else@*/ /*@cc_on if(typeof a.constructor!="function"){return typeOf(a)==typeof b.prototype.valueOf()}@*/ /*@if(@_14<5.1)if($Legacy.instanceOf(a,b))return true;@else@*/ if (a instanceof b)
    return true; /*@end@*/ /*@end@*/ if (Base.ancestorOf == b.ancestorOf)
    return false; if (Base.ancestorOf == a.constructor.ancestorOf)
    return b == Object; switch (b) {
