...
var drawBoxes = function () {
    ...
    // FIXME: There's a selection bug when :before { width:160px; height:120px } is set
    ...
    var cssHack = ":nth-char(0):before {content: url('test.jpg'); width:100px; height:75px; } :nth-char(0) {font: 14px arial} :nth-char(13){font: bold 24px arial} :nth-char(22){font: italic 20px arial} :nth-char(104):before{content: url('[canvas.jpg]');} :nth-char(108) {font: 14px sans-serif} :nth-char(130){font: 32px arial} :nth-char(153){font: 22px sans}";
