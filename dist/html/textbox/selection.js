...
colorjack.textbox.ui.VisualSelection = function () {
    ...
    var getSelection = function () {
        var r = range;
        return copyRange(r.startContainer, r.startOffset, r.endContainer, r.endOffset);
    };
    var getSortedSelection = function () {
        var s = getSelection();
        ...
        var sorted = (diff >= 0) ? s :
            copyRange(s.endContainer, s.endOffset, s.startContainer, s.startOffset);
        return sorted;
    };
    // --------------------------------------------------------------------------------------------
